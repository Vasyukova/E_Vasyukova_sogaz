...
public class testsContactCreation extends TestBase{
    ...
    public void testContact() throws Exception
    {
        ...
        appobj.getContactHelper().contactCreation(new GroupContData("Elena", "Vasyukova", "Korolev, Akademika Legostaeva", "89990006666", "Vasyukova.Elena@sogaz.ru", "29", "May", "1990"));
